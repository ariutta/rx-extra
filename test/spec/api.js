...
Rx.Observable.addToObject({
  ...
  fromUnpausableStream: require('../../lib/from-unpausable-stream.js'),
  fromReadableStream: RxNode.fromReadableStream,
...
//  });
//
//  it('should run Rx.Observable.prototype.pipe', function(done) {
...
////  });
  ...
  it('should convert unpausable stream to Observable', function(done) {
    ...
    Rx.Observable.fromUnpausableStream(s)
    .toArray()
    .subscribe(function(actual) {
